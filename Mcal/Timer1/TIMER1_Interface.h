...
void mTIMER1_Init(void);                               // → configure CTC mode with given settings.
void mTIMER1_Start(void);                              // → enable Timer1 operation.
void mTIMER1_Stop(void);                               // → disable Timer1.
void mTIMER1_RegisterCallback(void (*callback)(void)); // → optional callback for Compare Match ISR.
