...
![Type](https://img.shields.io/badge/Type-Hardware_Reference-brightgreen)
...
- [Power Supply](#-power-supply-components)
- [Passives & Miscellaneous](#-passives--miscellaneous)
...
| ----------------------------------------------------------------------------------------------------------- | ----------------- | ------------ |
| **[BOM.md](../BOM/BOM.md)**                                                                                 | Bill of Materials | ✅ Available |
...
| Attribute            | Value                     |
| -------------------- | ------------------------- |
| **Document Type**    | Component Datasheets List |
