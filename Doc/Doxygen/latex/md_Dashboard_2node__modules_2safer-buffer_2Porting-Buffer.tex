...
\hypertarget{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer}{}\label{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer}\index{Porting to the Buffer.from/Buffer.alloc API@{Porting to the Buffer.from/Buffer.alloc API}}
\label{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_autotoc_md2317}%
\Hypertarget{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_autotoc_md2317}%
 \label{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_overview}%
\Hypertarget{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_overview}%
 \hypertarget{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_autotoc_md2318}{}\doxysection{\texorpdfstring{Overview}{Overview}}\label{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_autotoc_md2318}

\begin{DoxyItemize}
\item \doxylink{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_variant-1}{Variant 1\+: Drop support for Node.js ≤ 4.4.x and 5.0.0 — 5.9.x.} ({\itshape recommended})
\item \doxylink{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_variant-2}{Variant 2\+: Use a polyfill}
\item \doxylink{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_variant-3}{Variant 3\+: manual detection, with safeguards}
\end{DoxyItemize}\hypertarget{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_autotoc_md2319}{}\doxysubsection{\texorpdfstring{Finding problematic bits of code using grep}{Finding problematic bits of code using grep}}\label{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_autotoc_md2319}
...
It will find all the potentially unsafe places in your own code (with some considerably unlikely exceptions).\hypertarget{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_autotoc_md2320}{}\doxysubsection{\texorpdfstring{Finding problematic bits of code using Node.\+js 8}{Finding problematic bits of code using Node.js 8}}\label{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_autotoc_md2320}
...
\end{DoxyCode}
\hypertarget{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_autotoc_md2321}{}\doxysubsection{\texorpdfstring{Finding problematic bits of code using linters}{Finding problematic bits of code using linters}}\label{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_autotoc_md2321}
...
\label{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_variant-1}%
\Hypertarget{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_variant-1}%
 \hypertarget{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_autotoc_md2322}{}\doxysection{\texorpdfstring{Variant 1\+: Drop support for Node.\+js ≤ 4.\+4.\+x and 5.\+0.\+0 — 5.\+9.\+x.}{Variant 1: Drop support for Node.js ≤ 4.4.x and 5.0.0 — 5.9.x.}}\label{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_autotoc_md2322}
...
{\itshape If you currently support those older Node.\+js versions and dropping them would be a semver-\/major change for you, or if you support older branches of your packages, consider using \doxylink{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_variant-2}{Variant 2} or \doxylink{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_variant-3}{Variant 3} on older branches, so people using those older branches will also receive the fix. That way, you will eradicate potential issues caused by unguarded Buffer API usage and your users will not observe a runtime deprecation warning when running your code on Node.\+js 10.}

\label{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_variant-2}%
\Hypertarget{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_variant-2}%
 \hypertarget{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_autotoc_md2323}{}\doxysection{\texorpdfstring{Variant 2\+: Use a polyfill}{Variant 2: Use a polyfill}}\label{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_autotoc_md2323}
Utilize \href{https://www.npmjs.com/package/safer-buffer}{\texttt{ safer-\/buffer}} as a polyfill to support older Node.\+js versions.

You would take exacly the same steps as in \doxylink{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_variant-1}{Variant 1}, but with a polyfill `const Buffer = require(\textquotesingle{}safer-\/buffer').Buffer{\ttfamily in all files where you use the new}Buffer\`{} api.
...
\label{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_variant-3}%
\Hypertarget{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_variant-3}%
 \hypertarget{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_autotoc_md2324}{}\doxysection{\texorpdfstring{Variant 3 — manual detection, with safeguards}{Variant 3 — manual detection, with safeguards}}\label{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_autotoc_md2324}
This is useful if you create Buffer instances in only a few places (e.\+g. one), or you have your own wrapper around them.\hypertarget{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_autotoc_md2325}{}\doxysubsection{\texorpdfstring{Buffer(0)}{Buffer(0)}}\label{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_autotoc_md2325}
This special case for creating empty buffers can be safely replaced with {\ttfamily Buffer.\+concat(\mbox{[}$\,$\mbox{]})}, which returns the same result all the way down to Node.\+js 0.\+8.\+x.\hypertarget{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_autotoc_md2326}{}\doxysubsection{\texorpdfstring{Buffer(not\+Number)}{Buffer(notNumber)}}\label{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_autotoc_md2326}
Before\+:
...
Also note that using Type\+Script does not fix this problem for you — when libs written in {\ttfamily Type\+Script} are used from JS, or when user input ends up there — it behaves exactly as pure JS, as all type checks are translation-\/time only and are not present in the actual JS code which TS compiles to.\hypertarget{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_autotoc_md2327}{}\doxysubsection{\texorpdfstring{Buffer(number)}{Buffer(number)}}\label{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_autotoc_md2327}
...
\end{DoxyCode}
\hypertarget{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_autotoc_md2328}{}\doxysection{\texorpdfstring{Regarding Buffer.\+alloc\+Unsafe}{Regarding Buffer.allocUnsafe}}\label{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_autotoc_md2328}
...
\label{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_faq}%
\Hypertarget{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_faq}%
 \hypertarget{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_autotoc_md2329}{}\doxysection{\texorpdfstring{FAQ}{FAQ}}\label{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_autotoc_md2329}
\label{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_design-flaws}%
\Hypertarget{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_design-flaws}%
 \hypertarget{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_autotoc_md2330}{}\doxysubsection{\texorpdfstring{What is wrong with the $<$tt$>$\+Buffer$<$/tt$>$ constructor?}{What is wrong with the <tt>Buffer</tt> constructor?}}\label{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_autotoc_md2330}
...
\label{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_ecosystem-usage}%
\Hypertarget{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_ecosystem-usage}%
 \hypertarget{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_autotoc_md2331}{}\doxysubsection{\texorpdfstring{The $<$tt$>$\+Buffer()$<$/tt$>$ constructor has been deprecated for a while. Is this really an issue?}{The <tt>Buffer()</tt> constructor has been deprecated for a while. Is this really an issue?}}\label{md_Dashboard_2node__modules_2safer-buffer_2Porting-Buffer_autotoc_md2331}
