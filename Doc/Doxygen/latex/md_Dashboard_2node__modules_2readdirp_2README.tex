\chapter{readdirp \texorpdfstring{$<$}{<}a href="{}https\+://github.\+com/paulmillr/readdirp"{} \texorpdfstring{$>$}{>}\texorpdfstring{$<$}{<}img src="{}https\+://img.\+shields.\+io/npm/dw/readdirp.\+svg"{} alt="{}\+Weekly downloads"{}/\texorpdfstring{$>$}{>}\texorpdfstring{$<$}{<}/a\texorpdfstring{$>$}{>}}
\hypertarget{md_Dashboard_2node__modules_2readdirp_2README}{}\label{md_Dashboard_2node__modules_2readdirp_2README}\index{readdirp $<$a href="{}https://github.com/paulmillr/readdirp"{} $>$$<$img src="{}https://img.shields.io/npm/dw/readdirp.svg"{} alt="{}Weekly downloads"{}/$>$$<$/a$>$@{readdirp $<$a href=""https://github.com/paulmillr/readdirp"" $>$$<$img src=""https://img.shields.io/npm/dw/readdirp.svg"" alt=""Weekly downloads""/$>$$<$/a$>$}}
\label{md_Dashboard_2node__modules_2readdirp_2README_autotoc_md2282}%
\Hypertarget{md_Dashboard_2node__modules_2readdirp_2README_autotoc_md2282}%
...
For more examples, check out {\ttfamily examples} directory.\hypertarget{md_Dashboard_2node__modules_2readdirp_2README_autotoc_md2283}{}\doxysection{\texorpdfstring{API}{API}}\label{md_Dashboard_2node__modules_2readdirp_2README_autotoc_md2283}
...
First argument is awalys {\ttfamily root}, path in which to start reading and recursing into subdirectories.\hypertarget{md_Dashboard_2node__modules_2readdirp_2README_autotoc_md2284}{}\doxysubsection{\texorpdfstring{options}{options}}\label{md_Dashboard_2node__modules_2readdirp_2README_autotoc_md2284}
...
\end{DoxyItemize}\hypertarget{md_Dashboard_2node__modules_2readdirp_2README_autotoc_md2285}{}\doxysubsection{\texorpdfstring{$<$tt$>$\+Entry\+Info$<$/tt$>$}{<tt>EntryInfo</tt>}}\label{md_Dashboard_2node__modules_2readdirp_2README_autotoc_md2285}
...
\end{DoxyItemize}\hypertarget{md_Dashboard_2node__modules_2readdirp_2README_autotoc_md2286}{}\doxysection{\texorpdfstring{Changelog}{Changelog}}\label{md_Dashboard_2node__modules_2readdirp_2README_autotoc_md2286}
...
{\ttfamily {\ttfamily }}\hypertarget{md_Dashboard_2node__modules_2readdirp_2README_autotoc_md2287}{}\doxysection{\texorpdfstring{License}{License}}\label{md_Dashboard_2node__modules_2readdirp_2README_autotoc_md2287}
{\ttfamily {\ttfamily }}

{\ttfamily {\ttfamily Copyright (c) 2012-\/2019 Thorsten Lorenz, Paul Miller (\href{https://paulmillr.com}{\texttt{ https\+://paulmillr.\+com}})}}

{\ttfamily {\ttfamily MIT License, see \mbox{[}LICENSE\mbox{]}(LICENSE) file. }}