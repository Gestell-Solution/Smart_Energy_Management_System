\chapter{cors}
\hypertarget{md_Dashboard_2node__modules_2cors_2README}{}\label{md_Dashboard_2node__modules_2cors_2README}\index{cors@{cors}}
\label{md_Dashboard_2node__modules_2cors_2README_autotoc_md545}%
\Hypertarget{md_Dashboard_2node__modules_2cors_2README_autotoc_md545}%
...
\item Author
\end{DoxyItemize}\hypertarget{md_Dashboard_2node__modules_2cors_2README_autotoc_md546}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{md_Dashboard_2node__modules_2cors_2README_autotoc_md546}
...
\end{DoxyCode}
\hypertarget{md_Dashboard_2node__modules_2cors_2README_autotoc_md547}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{md_Dashboard_2node__modules_2cors_2README_autotoc_md547}
\hypertarget{md_Dashboard_2node__modules_2cors_2README_autotoc_md548}{}\doxysubsection{\texorpdfstring{Simple Usage (\+Enable $<$em$>$\+All$<$/em$>$ CORS Requests)}{Simple Usage (Enable <em>All</em> CORS Requests)}}\label{md_Dashboard_2node__modules_2cors_2README_autotoc_md548}
...
\end{DoxyCode}
\hypertarget{md_Dashboard_2node__modules_2cors_2README_autotoc_md549}{}\doxysubsection{\texorpdfstring{Enable CORS for a Single Route}{Enable CORS for a Single Route}}\label{md_Dashboard_2node__modules_2cors_2README_autotoc_md549}
...
\end{DoxyCode}
\hypertarget{md_Dashboard_2node__modules_2cors_2README_autotoc_md550}{}\doxysubsection{\texorpdfstring{Configuring CORS}{Configuring CORS}}\label{md_Dashboard_2node__modules_2cors_2README_autotoc_md550}
...
\end{DoxyCode}
\hypertarget{md_Dashboard_2node__modules_2cors_2README_autotoc_md551}{}\doxysubsection{\texorpdfstring{Configuring CORS w/ Dynamic Origin}{Configuring CORS w/ Dynamic Origin}}\label{md_Dashboard_2node__modules_2cors_2README_autotoc_md551}
...
\end{DoxyCode}
\hypertarget{md_Dashboard_2node__modules_2cors_2README_autotoc_md552}{}\doxysubsection{\texorpdfstring{Enabling CORS Pre-\/\+Flight}{Enabling CORS Pre-Flight}}\label{md_Dashboard_2node__modules_2cors_2README_autotoc_md552}
...
\end{DoxyCode}
\hypertarget{md_Dashboard_2node__modules_2cors_2README_autotoc_md553}{}\doxysubsection{\texorpdfstring{Configuring CORS Asynchronously}{Configuring CORS Asynchronously}}\label{md_Dashboard_2node__modules_2cors_2README_autotoc_md553}
...
\end{DoxyCode}
\hypertarget{md_Dashboard_2node__modules_2cors_2README_autotoc_md554}{}\doxysection{\texorpdfstring{Configuration Options}{Configuration Options}}\label{md_Dashboard_2node__modules_2cors_2README_autotoc_md554}
...
For details on the effect of each CORS header, read \href{http://www.html5rocks.com/en/tutorials/cors/}{\texttt{ this}} article on HTML5 Rocks.\hypertarget{md_Dashboard_2node__modules_2cors_2README_autotoc_md555}{}\doxysection{\texorpdfstring{Demo}{Demo}}\label{md_Dashboard_2node__modules_2cors_2README_autotoc_md555}
...
\end{DoxyItemize}\hypertarget{md_Dashboard_2node__modules_2cors_2README_autotoc_md556}{}\doxysection{\texorpdfstring{License}{License}}\label{md_Dashboard_2node__modules_2cors_2README_autotoc_md556}
\href{http://www.opensource.org/licenses/mit-license.php}{\texttt{ MIT License}}\hypertarget{md_Dashboard_2node__modules_2cors_2README_autotoc_md557}{}\doxysection{\texorpdfstring{Author}{Author}}\label{md_Dashboard_2node__modules_2cors_2README_autotoc_md557}
