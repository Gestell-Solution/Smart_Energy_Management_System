\chapter{proxy-\/addr}
\hypertarget{md_Dashboard_2node__modules_2proxy-addr_2README}{}\label{md_Dashboard_2node__modules_2proxy-addr_2README}\index{proxy-\/addr@{proxy-\/addr}}
\label{md_Dashboard_2node__modules_2proxy-addr_2README_autotoc_md2139}%
\Hypertarget{md_Dashboard_2node__modules_2proxy-addr_2README_autotoc_md2139}%
...
Determine address of proxied request\hypertarget{md_Dashboard_2node__modules_2proxy-addr_2README_autotoc_md2140}{}\doxysection{\texorpdfstring{Install}{Install}}\label{md_Dashboard_2node__modules_2proxy-addr_2README_autotoc_md2140}
...
\end{DoxyCode}
\hypertarget{md_Dashboard_2node__modules_2proxy-addr_2README_autotoc_md2141}{}\doxysection{\texorpdfstring{API}{API}}\label{md_Dashboard_2node__modules_2proxy-addr_2README_autotoc_md2141}

\begin{DoxyCode}{0}
\DoxyCodeLine{var\ proxyaddr\ =\ require('proxy-\/addr')}

\end{DoxyCode}
\hypertarget{md_Dashboard_2node__modules_2proxy-addr_2README_autotoc_md2142}{}\doxysubsection{\texorpdfstring{proxyaddr(req, trust)}{proxyaddr(req, trust)}}\label{md_Dashboard_2node__modules_2proxy-addr_2README_autotoc_md2142}
...
\end{DoxyCode}
\hypertarget{md_Dashboard_2node__modules_2proxy-addr_2README_autotoc_md2144}{}\doxysubsection{\texorpdfstring{proxyaddr.\+compile(val)}{proxyaddr.compile(val)}}\label{md_Dashboard_2node__modules_2proxy-addr_2README_autotoc_md2144}
...
This function is meant to be optimized for use against every request. It is recommend to compile a trust function up-\/front for the trusted configuration and pass that to {\ttfamily proxyaddr(req, trust)} for each request.\hypertarget{md_Dashboard_2node__modules_2proxy-addr_2README_autotoc_md2145}{}\doxysection{\texorpdfstring{Testing}{Testing}}\label{md_Dashboard_2node__modules_2proxy-addr_2README_autotoc_md2145}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ test}

\end{DoxyCode}
\hypertarget{md_Dashboard_2node__modules_2proxy-addr_2README_autotoc_md2146}{}\doxysection{\texorpdfstring{Benchmarks}{Benchmarks}}\label{md_Dashboard_2node__modules_2proxy-addr_2README_autotoc_md2146}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ run-\/script\ bench}

\end{DoxyCode}
\hypertarget{md_Dashboard_2node__modules_2proxy-addr_2README_autotoc_md2147}{}\doxysection{\texorpdfstring{License}{License}}\label{md_Dashboard_2node__modules_2proxy-addr_2README_autotoc_md2147}
