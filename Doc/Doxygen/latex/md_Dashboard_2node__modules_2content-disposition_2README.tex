...
\hypertarget{md_Dashboard_2node__modules_2content-disposition_2README}{}\label{md_Dashboard_2node__modules_2content-disposition_2README}\index{content-\/disposition@{content-\/disposition}}
\label{md_Dashboard_2node__modules_2content-disposition_2README_autotoc_md468}%
\Hypertarget{md_Dashboard_2node__modules_2content-disposition_2README_autotoc_md468}%
...
Create and parse HTTP {\ttfamily Content-\/\+Disposition} header\hypertarget{md_Dashboard_2node__modules_2content-disposition_2README_autotoc_md469}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{md_Dashboard_2node__modules_2content-disposition_2README_autotoc_md469}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ install\ content-\/disposition}

\end{DoxyCode}
\hypertarget{md_Dashboard_2node__modules_2content-disposition_2README_autotoc_md470}{}\doxysection{\texorpdfstring{API}{API}}\label{md_Dashboard_2node__modules_2content-disposition_2README_autotoc_md470}

\begin{DoxyCode}{0}
\DoxyCodeLine{var\ contentDisposition\ =\ require('content-\/disposition')}

\end{DoxyCode}
\hypertarget{md_Dashboard_2node__modules_2content-disposition_2README_autotoc_md471}{}\doxysubsection{\texorpdfstring{content\+Disposition(filename, options)}{contentDisposition(filename, options)}}\label{md_Dashboard_2node__modules_2content-disposition_2README_autotoc_md471}
...
{\bfseries{note}} HTTP headers are of the ISO-\/8859-\/1 character set. If you are writing this header through a means different from {\ttfamily set\+Header} in Node.\+js, you\textquotesingle{}ll want to specify the `\textquotesingle{}binary'\`{} encoding in Node.\+js.\hypertarget{md_Dashboard_2node__modules_2content-disposition_2README_autotoc_md472}{}\doxysubsubsection{\texorpdfstring{Options}{Options}}\label{md_Dashboard_2node__modules_2content-disposition_2README_autotoc_md472}
{\ttfamily content\+Disposition} accepts these properties in the options object.\hypertarget{md_Dashboard_2node__modules_2content-disposition_2README_autotoc_md473}{}\doxyparagraph{\texorpdfstring{fallback}{fallback}}\label{md_Dashboard_2node__modules_2content-disposition_2README_autotoc_md473}
...
If the {\ttfamily filename} option is ISO-\/8859-\/1 and this option is specified and has a different value, then the {\ttfamily filename} option is encoded in the extended field and this set as the fallback field, even though they are both ISO-\/8859-\/1.\hypertarget{md_Dashboard_2node__modules_2content-disposition_2README_autotoc_md474}{}\doxyparagraph{\texorpdfstring{type}{type}}\label{md_Dashboard_2node__modules_2content-disposition_2README_autotoc_md474}
Specifies the disposition type, defaults to {\ttfamily "{}attachment"{}}. This can also be {\ttfamily "{}inline"{}}, or any other value (all values except inline are treated like {\ttfamily attachment}, but can convey additional information if both parties agree to it). The type is normalized to lower-\/case.\hypertarget{md_Dashboard_2node__modules_2content-disposition_2README_autotoc_md475}{}\doxysubsection{\texorpdfstring{content\+Disposition.\+parse(string)}{contentDisposition.parse(string)}}\label{md_Dashboard_2node__modules_2content-disposition_2README_autotoc_md475}
...
\end{DoxyItemize}\hypertarget{md_Dashboard_2node__modules_2content-disposition_2README_autotoc_md476}{}\doxysection{\texorpdfstring{Examples}{Examples}}\label{md_Dashboard_2node__modules_2content-disposition_2README_autotoc_md476}
\hypertarget{md_Dashboard_2node__modules_2content-disposition_2README_autotoc_md477}{}\doxysubsection{\texorpdfstring{Send a file for download}{Send a file for download}}\label{md_Dashboard_2node__modules_2content-disposition_2README_autotoc_md477}
...
\end{DoxyCode}
\hypertarget{md_Dashboard_2node__modules_2content-disposition_2README_autotoc_md478}{}\doxysection{\texorpdfstring{Testing}{Testing}}\label{md_Dashboard_2node__modules_2content-disposition_2README_autotoc_md478}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ test}

\end{DoxyCode}
\hypertarget{md_Dashboard_2node__modules_2content-disposition_2README_autotoc_md479}{}\doxysection{\texorpdfstring{References}{References}}\label{md_Dashboard_2node__modules_2content-disposition_2README_autotoc_md479}
...
\end{DoxyItemize}\hypertarget{md_Dashboard_2node__modules_2content-disposition_2README_autotoc_md480}{}\doxysection{\texorpdfstring{License}{License}}\label{md_Dashboard_2node__modules_2content-disposition_2README_autotoc_md480}
