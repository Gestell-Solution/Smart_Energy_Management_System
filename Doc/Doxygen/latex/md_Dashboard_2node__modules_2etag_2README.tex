\chapter{etag}
\hypertarget{md_Dashboard_2node__modules_2etag_2README}{}\label{md_Dashboard_2node__modules_2etag_2README}\index{etag@{etag}}
\label{md_Dashboard_2node__modules_2etag_2README_autotoc_md815}%
\Hypertarget{md_Dashboard_2node__modules_2etag_2README_autotoc_md815}%
...
This module generates HTTP ETags (as defined in RFC 7232) for use in HTTP responses.\hypertarget{md_Dashboard_2node__modules_2etag_2README_autotoc_md816}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{md_Dashboard_2node__modules_2etag_2README_autotoc_md816}
...
\end{DoxyCode}
\hypertarget{md_Dashboard_2node__modules_2etag_2README_autotoc_md817}{}\doxysection{\texorpdfstring{API}{API}}\label{md_Dashboard_2node__modules_2etag_2README_autotoc_md817}

\begin{DoxyCode}{0}
\DoxyCodeLine{var\ etag\ =\ require('etag')}

\end{DoxyCode}
\hypertarget{md_Dashboard_2node__modules_2etag_2README_autotoc_md818}{}\doxysubsection{\texorpdfstring{etag(entity, \mbox{[}options\mbox{]})}{etag(entity, [options])}}\label{md_Dashboard_2node__modules_2etag_2README_autotoc_md818}
...
\end{DoxyCode}
\hypertarget{md_Dashboard_2node__modules_2etag_2README_autotoc_md819}{}\doxysubsubsection{\texorpdfstring{Options}{Options}}\label{md_Dashboard_2node__modules_2etag_2README_autotoc_md819}
{\ttfamily etag} accepts these properties in the options object.\hypertarget{md_Dashboard_2node__modules_2etag_2README_autotoc_md820}{}\doxyparagraph{\texorpdfstring{weak}{weak}}\label{md_Dashboard_2node__modules_2etag_2README_autotoc_md820}
Specifies if the generated ETag will include the weak validator mark (that is, the leading {\ttfamily W/}). The actual entity tag is the same. The default value is {\ttfamily false}, unless the {\ttfamily entity} is {\ttfamily fs.\+Stats}, in which case it is {\ttfamily true}.\hypertarget{md_Dashboard_2node__modules_2etag_2README_autotoc_md821}{}\doxysection{\texorpdfstring{Testing}{Testing}}\label{md_Dashboard_2node__modules_2etag_2README_autotoc_md821}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ test}

\end{DoxyCode}
\hypertarget{md_Dashboard_2node__modules_2etag_2README_autotoc_md822}{}\doxysection{\texorpdfstring{Benchmark}{Benchmark}}\label{md_Dashboard_2node__modules_2etag_2README_autotoc_md822}
...
\end{DoxyCode}
\hypertarget{md_Dashboard_2node__modules_2etag_2README_autotoc_md823}{}\doxysection{\texorpdfstring{License}{License}}\label{md_Dashboard_2node__modules_2etag_2README_autotoc_md823}
