\chapter{README}
\hypertarget{md_Dashboard_2node__modules_2qs_2README}{}\label{md_Dashboard_2node__modules_2qs_2README}\index{README@{README}}


 \hypertarget{md_Dashboard_2node__modules_2qs_2README_autotoc_md2234}{}\doxysection{\texorpdfstring{qs $<$sup$>$$<$a href="{}https\+://npmjs.\+org/package/qs"{} $>$$<$img src="{}https\+://versionbadg.\+es/ljharb/qs.\+svg"{} alt="{}\+Version Badge"{}/$>$$<$/a$>$$<$/sup$>$}{qs <sup><a href="https://npmjs.org/package/qs" ><img src="https://versionbadg.es/ljharb/qs.svg" alt="Version Badge"/></a></sup>}}\label{md_Dashboard_2node__modules_2qs_2README_autotoc_md2234}
...
The {\bfseries{qs}} module was originally created and maintained by \href{https://github.com/visionmedia/node-querystring}{\texttt{ TJ Holowaychuk}}.\hypertarget{md_Dashboard_2node__modules_2qs_2README_autotoc_md2235}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{md_Dashboard_2node__modules_2qs_2README_autotoc_md2235}
...
\end{DoxyCode}
\hypertarget{md_Dashboard_2node__modules_2qs_2README_autotoc_md2236}{}\doxysubsubsection{\texorpdfstring{Parsing Objects}{Parsing Objects}}\label{md_Dashboard_2node__modules_2qs_2README_autotoc_md2236}
...
When using the {\ttfamily plain\+Objects} option the parsed value is returned as a null object, created via {\ttfamily \{ \+\_\+\+\_\+proto\+\_\+\+\_\+\+: null \}} and as such you should be aware that prototype methods will not exist on it and a user may set those names to whatever value they like\+:
...
If you want an error to be thrown whenever the a limit is exceeded (eg, {\ttfamily parameter\+Limit}, {\ttfamily array\+Limit}), set the {\ttfamily throw\+On\+Limit\+Exceeded} option to {\ttfamily true}. This option will generate a descriptive error if the query string exceeds a configured limit. 
\begin{DoxyCode}{0}
\DoxyCodeLine{try\ \{}
\DoxyCodeLine{\ \ \ \ qs.parse('a=1\&b=2\&c=3\&d=4',\ \{\ parameterLimit:\ 3,\ throwOnLimitExceeded:\ true\ \});}
\DoxyCodeLine{\}\ catch\ (err)\ \{}
\DoxyCodeLine{\ \ \ \ assert(err\ instanceof\ Error);}
\DoxyCodeLine{\ \ \ \ assert.strictEqual(err.message,\ 'Parameter\ limit\ exceeded.\ Only\ 3\ parameters\ allowed.');}
\DoxyCodeLine{\}}

\end{DoxyCode}


When {\ttfamily throw\+On\+Limit\+Exceeded} is set to {\ttfamily false} (default), {\bfseries{qs}} will parse up to the specified {\ttfamily parameter\+Limit} and ignore the rest without throwing an error.
...
It also works when the charset has been detected in {\ttfamily charset\+Sentinel} mode.\hypertarget{md_Dashboard_2node__modules_2qs_2README_autotoc_md2237}{}\doxysubsubsection{\texorpdfstring{Parsing Arrays}{Parsing Arrays}}\label{md_Dashboard_2node__modules_2qs_2README_autotoc_md2237}
...
If you want to throw an error whenever the array limit is exceeded, set the {\ttfamily throw\+On\+Limit\+Exceeded} option to {\ttfamily true}. This option will generate a descriptive error if the query string exceeds a configured limit. 
\begin{DoxyCode}{0}
\DoxyCodeLine{try\ \{}
\DoxyCodeLine{\ \ \ \ qs.parse('a[1]=b',\ \{\ arrayLimit:\ 0,\ throwOnLimitExceeded:\ true\ \});}
\DoxyCodeLine{\}\ catch\ (err)\ \{}
\DoxyCodeLine{\ \ \ \ assert(err\ instanceof\ Error);}
\DoxyCodeLine{\ \ \ \ assert.strictEqual(err.message,\ 'Array\ limit\ exceeded.\ Only\ 0\ elements\ allowed\ in\ an\ array.');}
\DoxyCodeLine{\}}

\end{DoxyCode}


When {\ttfamily throw\+On\+Limit\+Exceeded} is set to {\ttfamily false} (default), {\bfseries{qs}} will parse up to the specified {\ttfamily array\+Limit} and if the limit is exceeded, the array will instead be converted to an object with the index as the key
...
\end{DoxyCode}
 ({\itshape this cannot convert nested objects, such as {\ttfamily a=\{b\+:1\},\{c\+:d\}}})\hypertarget{md_Dashboard_2node__modules_2qs_2README_autotoc_md2238}{}\doxysubsubsection{\texorpdfstring{Parsing primitive/scalar values (numbers, booleans, null, etc)}{Parsing primitive/scalar values (numbers, booleans, null, etc)}}\label{md_Dashboard_2node__modules_2qs_2README_autotoc_md2238}
...
If you wish to auto-\/convert values which look like numbers, booleans, and other values into their primitive counterparts, you can use the \href{https://github.com/xpepermint/query-types}{\texttt{ query-\/types Express JS middleware}} which will auto-\/convert all request query parameters.\hypertarget{md_Dashboard_2node__modules_2qs_2README_autotoc_md2239}{}\doxysubsubsection{\texorpdfstring{Stringifying}{Stringifying}}\label{md_Dashboard_2node__modules_2qs_2README_autotoc_md2239}
\mbox{[}\mbox{]}(\#prevent\+Eval) 
\begin{DoxyCode}{0}
...
\end{DoxyCode}
\hypertarget{md_Dashboard_2node__modules_2qs_2README_autotoc_md2240}{}\doxysubsubsection{\texorpdfstring{Handling of $<$tt$>$null$<$/tt$>$ values}{Handling of <tt>null</tt> values}}\label{md_Dashboard_2node__modules_2qs_2README_autotoc_md2240}
...
\end{DoxyCode}
\hypertarget{md_Dashboard_2node__modules_2qs_2README_autotoc_md2241}{}\doxysubsubsection{\texorpdfstring{Dealing with special character sets}{Dealing with special character sets}}\label{md_Dashboard_2node__modules_2qs_2README_autotoc_md2241}
...
\end{DoxyCode}
\hypertarget{md_Dashboard_2node__modules_2qs_2README_autotoc_md2242}{}\doxysubsubsection{\texorpdfstring{RFC 3986 and RFC 1738 space encoding}{RFC 3986 and RFC 1738 space encoding}}\label{md_Dashboard_2node__modules_2qs_2README_autotoc_md2242}
...
\end{DoxyCode}
\hypertarget{md_Dashboard_2node__modules_2qs_2README_autotoc_md2243}{}\doxysubsection{\texorpdfstring{Security}{Security}}\label{md_Dashboard_2node__modules_2qs_2README_autotoc_md2243}
Please email \href{https://github.com/ljharb}{\texttt{ @ljharb}} or see \href{https://tidelift.com/security}{\texttt{ https\+://tidelift.\+com/security}} if you have a potential security vulnerability to report.\hypertarget{md_Dashboard_2node__modules_2qs_2README_autotoc_md2244}{}\doxysubsection{\texorpdfstring{qs for enterprise}{qs for enterprise}}\label{md_Dashboard_2node__modules_2qs_2README_autotoc_md2244}
Available as part of the Tidelift Subscription

The maintainers of qs and thousands of other packages are working with Tidelift to deliver commercial support and maintenance for the open source dependencies you use to build your applications. Save time, reduce risk, and improve code health, while paying the maintainers of the exact dependencies you use. \href{https://tidelift.com/subscription/pkg/npm-qs?utm_source=npm-qs&utm_medium=referral&utm_campaign=enterprise&utm_term=repo}{\texttt{ Learn more.}}\hypertarget{md_Dashboard_2node__modules_2qs_2README_autotoc_md2245}{}\doxysubsection{\texorpdfstring{Acknowledgements}{Acknowledgements}}\label{md_Dashboard_2node__modules_2qs_2README_autotoc_md2245}
qs logo by \href{https://github.com/numi-hq/open-design}{\texttt{ NUMI}}\+:

\href{https://numi.tech/?ref=qs}{\texttt{ \texorpdfstring{$<$}{<}img src="{}https\+://raw.\+githubusercontent.\+com/numi-\/hq/open-\/design/main/assets/numi-\/lockup.\+png"{} alt="{}NUMI Logo"{} style="{}width\+: 200px;"{}/\texorpdfstring{$>$}{>}}} 