...
ipaddr.\+js allows you to verify and parse string representation of an IP address, match it against a CIDR range or range list, determine if it falls into some reserved ranges (examples include loopback and private ranges), and convert between IPv4 and IPv4-\/mapped IPv6 addresses.\hypertarget{md_Dashboard_2node__modules_2ipaddr_8js_2README_autotoc_md1451}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{md_Dashboard_2node__modules_2ipaddr_8js_2README_autotoc_md1451}
{\ttfamily npm install ipaddr.\+js}

or

{\ttfamily bower install ipaddr.\+js}\hypertarget{md_Dashboard_2node__modules_2ipaddr_8js_2README_autotoc_md1452}{}\doxysection{\texorpdfstring{API}{API}}\label{md_Dashboard_2node__modules_2ipaddr_8js_2README_autotoc_md1452}
...
The API consists of several global methods and two classes\+: ipaddr.\+IPv6 and ipaddr.\+IPv4.\hypertarget{md_Dashboard_2node__modules_2ipaddr_8js_2README_autotoc_md1453}{}\doxysubsection{\texorpdfstring{Global methods}{Global methods}}\label{md_Dashboard_2node__modules_2ipaddr_8js_2README_autotoc_md1453}
...
The {\ttfamily ipaddr.\+process} method works just like the {\ttfamily ipaddr.\+parse} one, but it automatically converts IPv4-\/mapped IPv6 addresses to their IPv4 counterparts before returning. It is useful when you have a Node.\+js instance listening on an IPv6 socket, and the {\ttfamily net.\+ivp6.\+bindv6only} sysctl parameter (or its equivalent on non-\/\+Linux OS) is set to 0. In this case, you can accept IPv4 connections on your IPv6-\/only socket, but the remote address will be mangled. Use {\ttfamily ipaddr.\+process} method to automatically demangle it.\hypertarget{md_Dashboard_2node__modules_2ipaddr_8js_2README_autotoc_md1454}{}\doxysubsection{\texorpdfstring{Object representation}{Object representation}}\label{md_Dashboard_2node__modules_2ipaddr_8js_2README_autotoc_md1454}
Parsing methods return an object which descends from {\ttfamily ipaddr.\+IPv6} or {\ttfamily ipaddr.\+IPv4}. These objects share some properties, but most of them differ.\hypertarget{md_Dashboard_2node__modules_2ipaddr_8js_2README_autotoc_md1455}{}\doxysubsubsection{\texorpdfstring{Shared properties}{Shared properties}}\label{md_Dashboard_2node__modules_2ipaddr_8js_2README_autotoc_md1455}
...
\end{DoxyCode}
\hypertarget{md_Dashboard_2node__modules_2ipaddr_8js_2README_autotoc_md1457}{}\doxysubsubsection{\texorpdfstring{IPv4 properties}{IPv4 properties}}\label{md_Dashboard_2node__modules_2ipaddr_8js_2README_autotoc_md1457}
...
\end{DoxyCode}
\hypertarget{md_Dashboard_2node__modules_2ipaddr_8js_2README_autotoc_md1458}{}\doxysubsubsection{\texorpdfstring{Conversion}{Conversion}}\label{md_Dashboard_2node__modules_2ipaddr_8js_2README_autotoc_md1458}
