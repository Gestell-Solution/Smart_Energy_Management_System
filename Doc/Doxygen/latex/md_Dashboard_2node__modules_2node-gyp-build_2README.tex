...
\hypertarget{md_Dashboard_2node__modules_2node-gyp-build_2README}{}\label{md_Dashboard_2node__modules_2node-gyp-build_2README}\index{node-\/gyp-\/build@{node-\/gyp-\/build}}
\label{md_Dashboard_2node__modules_2node-gyp-build_2README_autotoc_md1830}%
\Hypertarget{md_Dashboard_2node__modules_2node-gyp-build_2README_autotoc_md1830}%
 \begin{quote}
...
Use together with \href{https://github.com/prebuild/prebuildify}{\texttt{ {\ttfamily prebuildify}}} to easily support prebuilds for your native modules.\hypertarget{md_Dashboard_2node__modules_2node-gyp-build_2README_autotoc_md1831}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{md_Dashboard_2node__modules_2node-gyp-build_2README_autotoc_md1831}
\begin{quote}
...
Prebuilds will be attempted loaded from {\ttfamily MODULE\+\_\+\+PATH/prebuilds/...} and then next {\ttfamily EXEC\+\_\+\+PATH/prebuilds/...} (the latter allowing use with {\ttfamily zeit/pkg})\hypertarget{md_Dashboard_2node__modules_2node-gyp-build_2README_autotoc_md1832}{}\doxysection{\texorpdfstring{Supported prebuild names}{Supported prebuild names}}\label{md_Dashboard_2node__modules_2node-gyp-build_2README_autotoc_md1832}
