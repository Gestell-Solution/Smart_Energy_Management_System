\chapter{http-\/errors}
\hypertarget{md_Dashboard_2node__modules_2http-errors_2README}{}\label{md_Dashboard_2node__modules_2http-errors_2README}\index{http-\/errors@{http-\/errors}}
\label{md_Dashboard_2node__modules_2http-errors_2README_autotoc_md1398}%
\Hypertarget{md_Dashboard_2node__modules_2http-errors_2README_autotoc_md1398}%
...
Create HTTP errors for Express, Koa, Connect, etc. with ease.\hypertarget{md_Dashboard_2node__modules_2http-errors_2README_autotoc_md1399}{}\doxysection{\texorpdfstring{Install}{Install}}\label{md_Dashboard_2node__modules_2http-errors_2README_autotoc_md1399}
...
\end{DoxyCode}
\hypertarget{md_Dashboard_2node__modules_2http-errors_2README_autotoc_md1400}{}\doxysection{\texorpdfstring{Example}{Example}}\label{md_Dashboard_2node__modules_2http-errors_2README_autotoc_md1400}
...
\end{DoxyCode}
\hypertarget{md_Dashboard_2node__modules_2http-errors_2README_autotoc_md1401}{}\doxysection{\texorpdfstring{API}{API}}\label{md_Dashboard_2node__modules_2http-errors_2README_autotoc_md1401}
This is the current API, currently extracted from Koa and subject to change.\hypertarget{md_Dashboard_2node__modules_2http-errors_2README_autotoc_md1402}{}\doxysubsection{\texorpdfstring{Error Properties}{Error Properties}}\label{md_Dashboard_2node__modules_2http-errors_2README_autotoc_md1402}
...
\end{DoxyItemize}\hypertarget{md_Dashboard_2node__modules_2http-errors_2README_autotoc_md1403}{}\doxysubsection{\texorpdfstring{create\+Error(\mbox{[}status\mbox{]}, \mbox{[}message\mbox{]}, \mbox{[}properties\mbox{]})}{createError([status], [message], [properties])}}\label{md_Dashboard_2node__modules_2http-errors_2README_autotoc_md1403}
...
\end{DoxyItemize}\hypertarget{md_Dashboard_2node__modules_2http-errors_2README_autotoc_md1404}{}\doxysubsection{\texorpdfstring{create\+Error(\mbox{[}status\mbox{]}, \mbox{[}error\mbox{]}, \mbox{[}properties\mbox{]})}{createError([status], [error], [properties])}}\label{md_Dashboard_2node__modules_2http-errors_2README_autotoc_md1404}
...
\item {\ttfamily properties} -\/ custom properties to attach to the object
\end{DoxyItemize}\hypertarget{md_Dashboard_2node__modules_2http-errors_2README_autotoc_md1405}{}\doxysubsection{\texorpdfstring{create\+Error.\+is\+Http\+Error(val)}{createError.isHttpError(val)}}\label{md_Dashboard_2node__modules_2http-errors_2README_autotoc_md1405}
Determine if the provided {\ttfamily val} is an {\ttfamily Http\+Error}. This will return {\ttfamily true} if the error inherits from the {\ttfamily Http\+Error} constructor of this module or matches the "{}duck type"{} for an error this module creates. All outputs from the {\ttfamily create\+Error} factory will return {\ttfamily true} for this function, including if an non-\/{\ttfamily Http\+Error} was passed into the factory.\hypertarget{md_Dashboard_2node__modules_2http-errors_2README_autotoc_md1406}{}\doxysubsection{\texorpdfstring{new create\+Error\mbox{[}code \texorpdfstring{$\vert$}{|}\texorpdfstring{$\vert$}{|} name\mbox{]}(\mbox{[}msg\mbox{]}))}{new createError[code || name]([msg]))}}\label{md_Dashboard_2node__modules_2http-errors_2README_autotoc_md1406}
Create a new error object with the given message {\ttfamily msg}. The error object inherits from {\ttfamily create\+Error.\+Http\+Error}.
...
\end{DoxyItemize}\hypertarget{md_Dashboard_2node__modules_2http-errors_2README_autotoc_md1407}{}\doxysubsubsection{\texorpdfstring{List of all constructors}{List of all constructors}}\label{md_Dashboard_2node__modules_2http-errors_2README_autotoc_md1407}
\tabulinesep=1mm
...
\end{longtabu}
\hypertarget{md_Dashboard_2node__modules_2http-errors_2README_autotoc_md1408}{}\doxysection{\texorpdfstring{License}{License}}\label{md_Dashboard_2node__modules_2http-errors_2README_autotoc_md1408}
