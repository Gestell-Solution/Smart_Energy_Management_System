\chapter{depd}
\hypertarget{md_Dashboard_2node__modules_2depd_2Readme}{}\label{md_Dashboard_2node__modules_2depd_2Readme}\index{depd@{depd}}
\label{md_Dashboard_2node__modules_2depd_2Readme_autotoc_md637}%
\Hypertarget{md_Dashboard_2node__modules_2depd_2Readme_autotoc_md637}%
...
\hypertarget{md_Dashboard_2node__modules_2depd_2Readme_autotoc_md638}{}\doxysection{\texorpdfstring{Install}{Install}}\label{md_Dashboard_2node__modules_2depd_2Readme_autotoc_md638}
...
This module can also be bundled with systems like \href{http://browserify.org/}{\texttt{ Browserify}} or \href{https://webpack.github.io/}{\texttt{ webpack}}, though by default this module will alter it\textquotesingle{}s API to no longer display or track deprecations.\hypertarget{md_Dashboard_2node__modules_2depd_2Readme_autotoc_md639}{}\doxysection{\texorpdfstring{API}{API}}\label{md_Dashboard_2node__modules_2depd_2Readme_autotoc_md639}
...
{\bfseries{NOTE}} this library has a similar interface to the {\ttfamily debug} module, and this module uses the calling file to get the boundary for the call stacks, so you should always create a new {\ttfamily deprecate} object in each file and not within some central file.\hypertarget{md_Dashboard_2node__modules_2depd_2Readme_autotoc_md640}{}\doxysubsection{\texorpdfstring{depd(namespace)}{depd(namespace)}}\label{md_Dashboard_2node__modules_2depd_2Readme_autotoc_md640}
Create a new deprecate function that uses the given namespace name in the messages and will display the call site prior to the stack entering the file this function was called from. It is highly suggested you use the name of your module as the namespace.\hypertarget{md_Dashboard_2node__modules_2depd_2Readme_autotoc_md641}{}\doxysubsection{\texorpdfstring{deprecate(message)}{deprecate(message)}}\label{md_Dashboard_2node__modules_2depd_2Readme_autotoc_md641}
...
If the message is omitted, a message is generated for you based on the site of the {\ttfamily deprecate()} call and will display the name of the function called, similar to the name displayed in a stack trace.\hypertarget{md_Dashboard_2node__modules_2depd_2Readme_autotoc_md642}{}\doxysubsection{\texorpdfstring{deprecate.\+function(fn, message)}{deprecate.function(fn, message)}}\label{md_Dashboard_2node__modules_2depd_2Readme_autotoc_md642}
Call this function to wrap a given function in a deprecation message on any call to the function. An optional message can be supplied to provide a custom message.\hypertarget{md_Dashboard_2node__modules_2depd_2Readme_autotoc_md643}{}\doxysubsection{\texorpdfstring{deprecate.\+property(obj, prop, message)}{deprecate.property(obj, prop, message)}}\label{md_Dashboard_2node__modules_2depd_2Readme_autotoc_md643}
...
If the property is a data descriptor, it will be converted to an accessor descriptor in order to display the deprecation message.\hypertarget{md_Dashboard_2node__modules_2depd_2Readme_autotoc_md644}{}\doxysubsection{\texorpdfstring{process.\+on(\textquotesingle{}deprecation\textquotesingle{}, fn)}{process.on('deprecation', fn)}}\label{md_Dashboard_2node__modules_2depd_2Readme_autotoc_md644}
...
\end{DoxyCode}
\hypertarget{md_Dashboard_2node__modules_2depd_2Readme_autotoc_md645}{}\doxysubsection{\texorpdfstring{process.\+env.\+NO\+\_\+\+DEPRECATION}{process.env.NO\_DEPRECATION}}\label{md_Dashboard_2node__modules_2depd_2Readme_autotoc_md645}
...
{\bfseries{NOTE}} This will not suppress the deperecations given to any "{}deprecation"{} event listeners, just the output to STDERR.\hypertarget{md_Dashboard_2node__modules_2depd_2Readme_autotoc_md646}{}\doxysubsection{\texorpdfstring{process.\+env.\+TRACE\+\_\+\+DEPRECATION}{process.env.TRACE\_DEPRECATION}}\label{md_Dashboard_2node__modules_2depd_2Readme_autotoc_md646}
...
{\bfseries{NOTE}} This will not trace the deperecations silenced by {\ttfamily NO\+\_\+\+DEPRECATION}.\hypertarget{md_Dashboard_2node__modules_2depd_2Readme_autotoc_md647}{}\doxysection{\texorpdfstring{Display}{Display}}\label{md_Dashboard_2node__modules_2depd_2Readme_autotoc_md647}
...
\end{DoxyCode}
\hypertarget{md_Dashboard_2node__modules_2depd_2Readme_autotoc_md648}{}\doxysection{\texorpdfstring{Examples}{Examples}}\label{md_Dashboard_2node__modules_2depd_2Readme_autotoc_md648}
\hypertarget{md_Dashboard_2node__modules_2depd_2Readme_autotoc_md649}{}\doxysubsection{\texorpdfstring{Deprecating all calls to a function}{Deprecating all calls to a function}}\label{md_Dashboard_2node__modules_2depd_2Readme_autotoc_md649}
...
\end{DoxyCode}
\hypertarget{md_Dashboard_2node__modules_2depd_2Readme_autotoc_md650}{}\doxysubsection{\texorpdfstring{Conditionally deprecating a function call}{Conditionally deprecating a function call}}\label{md_Dashboard_2node__modules_2depd_2Readme_autotoc_md650}
...
\end{DoxyCode}
\hypertarget{md_Dashboard_2node__modules_2depd_2Readme_autotoc_md651}{}\doxysubsection{\texorpdfstring{Deprecating property access}{Deprecating property access}}\label{md_Dashboard_2node__modules_2depd_2Readme_autotoc_md651}
...
\end{DoxyCode}
\hypertarget{md_Dashboard_2node__modules_2depd_2Readme_autotoc_md652}{}\doxysection{\texorpdfstring{License}{License}}\label{md_Dashboard_2node__modules_2depd_2Readme_autotoc_md652}
