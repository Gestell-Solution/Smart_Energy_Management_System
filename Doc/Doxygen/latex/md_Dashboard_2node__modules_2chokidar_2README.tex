\chapter{Chokidar \texorpdfstring{$<$}{<}a href="{}https\+://github.\+com/paulmillr/chokidar"{} \texorpdfstring{$>$}{>}\texorpdfstring{$<$}{<}img src="{}https\+://img.\+shields.\+io/npm/dw/chokidar.\+svg"{} alt="{}\+Weekly downloads"{}/\texorpdfstring{$>$}{>}\texorpdfstring{$<$}{<}/a\texorpdfstring{$>$}{>} \texorpdfstring{$<$}{<}a href="{}https\+://github.\+com/paulmillr/chokidar"{} \texorpdfstring{$>$}{>}\texorpdfstring{$<$}{<}img src="{}https\+://img.\+shields.\+io/npm/dy/chokidar.\+svg"{} alt="{}\+Yearly downloads"{}/\texorpdfstring{$>$}{>}\texorpdfstring{$<$}{<}/a\texorpdfstring{$>$}{>}}
\hypertarget{md_Dashboard_2node__modules_2chokidar_2README}{}\label{md_Dashboard_2node__modules_2chokidar_2README}\index{Chokidar $<$a href="{}https://github.com/paulmillr/chokidar"{} $>$$<$img src="{}https://img.shields.io/npm/dw/chokidar.svg"{} alt="{}Weekly downloads"{}/$>$$<$/a$>$ $<$a href="{}https://github.com/paulmillr/chokidar"{} $>$$<$img src="{}https://img.shields.io/npm/dy/chokidar.svg"{} alt="{}Yearly downloads"{}/$>$$<$/a$>$@{Chokidar $<$a href=""https://github.com/paulmillr/chokidar"" $>$$<$img src=""https://img.shields.io/npm/dw/chokidar.svg"" alt=""Weekly downloads""/$>$$<$/a$>$ $<$a href=""https://github.com/paulmillr/chokidar"" $>$$<$img src=""https://img.shields.io/npm/dy/chokidar.svg"" alt=""Yearly downloads""/$>$$<$/a$>$}}
\label{md_Dashboard_2node__modules_2chokidar_2README_autotoc_md436}%
\Hypertarget{md_Dashboard_2node__modules_2chokidar_2README_autotoc_md436}%
 \begin{quote}
Minimal and efficient cross-\/platform file watching library \end{quote}
\href{https://www.npmjs.com/package/chokidar}{\texttt{ }}\hypertarget{md_Dashboard_2node__modules_2chokidar_2README_autotoc_md437}{}\doxysection{\texorpdfstring{Why?}{Why?}}\label{md_Dashboard_2node__modules_2chokidar_2README_autotoc_md437}
...
Version 3 is out! Check out our blog post about it\+: \href{https://paulmillr.com/posts/chokidar-3-save-32tb-of-traffic/}{\texttt{ Chokidar 3\+: How to save 32TB of traffic every week}}\hypertarget{md_Dashboard_2node__modules_2chokidar_2README_autotoc_md438}{}\doxysection{\texorpdfstring{How?}{How?}}\label{md_Dashboard_2node__modules_2chokidar_2README_autotoc_md438}
...
\end{DoxyCode}
\hypertarget{md_Dashboard_2node__modules_2chokidar_2README_autotoc_md440}{}\doxysection{\texorpdfstring{API}{API}}\label{md_Dashboard_2node__modules_2chokidar_2README_autotoc_md440}
...
\end{DoxyItemize}\hypertarget{md_Dashboard_2node__modules_2chokidar_2README_autotoc_md441}{}\doxysubsubsection{\texorpdfstring{Persistence}{Persistence}}\label{md_Dashboard_2node__modules_2chokidar_2README_autotoc_md441}
...
\end{DoxyItemize}\hypertarget{md_Dashboard_2node__modules_2chokidar_2README_autotoc_md442}{}\doxysubsubsection{\texorpdfstring{Path filtering}{Path filtering}}\label{md_Dashboard_2node__modules_2chokidar_2README_autotoc_md442}
...
\end{DoxyItemize}\hypertarget{md_Dashboard_2node__modules_2chokidar_2README_autotoc_md443}{}\doxysubsubsection{\texorpdfstring{Performance}{Performance}}\label{md_Dashboard_2node__modules_2chokidar_2README_autotoc_md443}
...
\begin{DoxyItemize}
\item \texorpdfstring{$\ast$}{*}{\ttfamily options.\+await\+Write\+Finish} can be set to an object in order to adjust timing params\+:\texorpdfstring{$\ast$}{*}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_Dashboard_2node__modules_2chokidar_2README_autotoc_md444}{}\doxysubsubsection{\texorpdfstring{Errors}{Errors}}\label{md_Dashboard_2node__modules_2chokidar_2README_autotoc_md444}
...
\end{DoxyItemize}\hypertarget{md_Dashboard_2node__modules_2chokidar_2README_autotoc_md445}{}\doxysubsection{\texorpdfstring{Methods \& Events}{Methods \& Events}}\label{md_Dashboard_2node__modules_2chokidar_2README_autotoc_md445}
...
\end{DoxyItemize}\hypertarget{md_Dashboard_2node__modules_2chokidar_2README_autotoc_md446}{}\doxysection{\texorpdfstring{CLI}{CLI}}\label{md_Dashboard_2node__modules_2chokidar_2README_autotoc_md446}
If you need a CLI interface for your file watching, check out \href{https://github.com/open-cli-tools/chokidar-cli}{\texttt{ chokidar-\/cli}}, allowing you to execute a command on each change, or get a stdio stream of change events.\hypertarget{md_Dashboard_2node__modules_2chokidar_2README_autotoc_md447}{}\doxysection{\texorpdfstring{Install Troubleshooting}{Install Troubleshooting}}\label{md_Dashboard_2node__modules_2chokidar_2README_autotoc_md447}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_Dashboard_2node__modules_2chokidar_2README_autotoc_md448}{}\doxysection{\texorpdfstring{Changelog}{Changelog}}\label{md_Dashboard_2node__modules_2chokidar_2README_autotoc_md448}
For more detailed changelog, see \`{}full\+\_\+changelog.md\`{}.
\begin{DoxyItemize}
...
\end{DoxyItemize}\hypertarget{md_Dashboard_2node__modules_2chokidar_2README_autotoc_md449}{}\doxysection{\texorpdfstring{Also}{Also}}\label{md_Dashboard_2node__modules_2chokidar_2README_autotoc_md449}
Why was chokidar named this way? What\textquotesingle{}s the meaning behind it?

\texorpdfstring{$>$}{>}Chowkidar is a transliteration of a Hindi word meaning \textquotesingle{}watchman, gatekeeper\textquotesingle{}, चौकीदार. This ultimately comes from Sanskrit \+\_\+ चतुष्क\+\_\+ (crossway, quadrangle, consisting-\/of-\/four). This word is also used in other languages like Urdu as (چوکیدار) which is widely used in Pakistan and India.\hypertarget{md_Dashboard_2node__modules_2chokidar_2README_autotoc_md450}{}\doxysection{\texorpdfstring{License}{License}}\label{md_Dashboard_2node__modules_2chokidar_2README_autotoc_md450}
